	...
	function stylizeDocument(){
		for (var i = 0; i < wics.rules.length; i++){
			...
			if (cObj.ITS_type == 'TRANSLATE'){
				...
				if (cObj.attributes.its_within_text == 'nested')
				{
					$('[wicsPointer="'+cObj.elemPointer+'"]').before('<img src=".WICS/img/nested-open.png" width="10px">');
					$('[wicsPointer="'+cObj.elemPointer+'"]').after('<img src=".WICS/img/nested-close.png" width="10px">');
				}

				else if (cObj.attributes.its_within_text == 'yes')
				{
					$('[wicsPointer="'+cObj.elemPointer+'"]').before('<img src=".WICS/img/yes-open.png" width="10px">');
					$('[wicsPointer="'+cObj.elemPointer+'"]').after('<img src=".WICS/img/yes-close.png" width="10px">');
				}

				else if (cObj.attributes.its_within_text == 'no')
				{
					$('[wicsPointer="'+cObj.elemPointer+'"]').before('<img src=".WICS/img/no.png" width="10px">');
					$('[wicsPointer="'+cObj.elemPointer+'"]').after('<img src=".WICS/img/no.png" width="10px">');
				}
			}
